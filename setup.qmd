...
Download and unzip to your project folder to follow along with the materials.

```{r}
#| echo: false
library(downloadthis)
download_link(
  link = "https://github.com/cambiotraining/stats-survival-analysis/tree/main/materials/data_SV.zip",
